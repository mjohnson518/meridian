...
export const SacredButton = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ 
    ...
    ...props 
      ...
      const variants = {
        primary: 'bg-gray-900 dark:bg-white text-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-gray-100 border-gray-900 dark:border-white shadow-sm',
        outline: 'bg-transparent text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-800 border-gray-300 dark:border-gray-700',
