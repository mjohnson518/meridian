...
export function LayoutContent({ children }: { children: React.ReactNode }) {
  return (
    <>
      {/* Header */}
      <header className="border-b border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-black/80 backdrop-blur-md sticky top-0 z-50 transition-colors">
        <div className="max-w-7xl mx-auto px-8">
          <nav className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-12">
              <a href="/" className="text-lg font-bold tracking-tight no-underline hover:opacity-70 transition-opacity text-black dark:text-white">
                MERIDIAN
              </a>
            ...
            <div className="flex items-center space-x-4">
              ...
              <a
                href="/portal/login"
                className="px-4 py-2 text-sm font-medium bg-black dark:bg-white text-white dark:text-black hover:bg-emerald-500 hover:text-white rounded-lg transition-all duration-200"
              >
                Launch Portal
              </a>
            </div>
      ...
      {/* Footer */}
      <footer className="border-t border-gray-200 dark:border-gray-800 mt-auto bg-white dark:bg-black">
              ...
              <ul className="space-y-2 font-mono text-xs">
                <li>
                  ...
                  <a 
                    ...
                    className="break-all hover:opacity-70 text-black dark:text-white"
                  >
                    0xbe3561...7499C9
                  </a>
                </li>
